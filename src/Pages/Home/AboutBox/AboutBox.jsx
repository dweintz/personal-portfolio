    ...
    <div className={`about-box`}>
      ...
      <div className="about-right">
        ...
        <p>
          ...
          front-end development. It’s still a work in progress, and I plan on
          adding more content and features soon. In the meantime, feel free to
          browse through the site to learn more about my experience, projects,
          and interests.
        </p>
      </div>
    </div>
