    ...
    <div className="content-page">
      ...
      <div className={`about-box2 slide-box slide-right`}>
        ...
        <p>
          ...
          with a passion for software engineering and using technology to solve
          meaningful problems. Much of my work centers on computer vision and
          artificial intelligence, where I focus on building systems that help
        ...
        <p>
          ...
          disconnecting, recharging, and finding new inspiration. I especially
          enjoy hiking and backpacking trips that take me a little “off-grid.”
        </p>
        <br></br>
        <p>
          ...
          Computer Engineering Student Society, where I am part of the External
          Media Committee. When I’m home, I like to unwind by building Legos, a
          childhood hobby that sparked my early interest in engineering and
          continues to fuel my creativity today.
        </p>
      </div>
