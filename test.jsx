    ...
    <>
      <div className={"project-box slide-box"}>
        ...
        <div className="project-desc">
          <p>
            As part of the Image Processing and Analysis with Applications
            (IPAA) team, I worked with a team to develop a pedestrian detector
            model for crash avoidance. We utilized object detection and
            classification techniques such as Histograms of Oriented Gradients
            (HOG) and Support Vector Machines (SVM). To filter results, we
            employed post-processing techniques like hard-negative mining,
            non-maximum suppression, and thresholding.
          </p>
          <br></br>
          <p>
            We paired the pedestrian detector with an algorithm to find the
            optimal path for an autonomous vehicle in near-collision scenarios
            and presented our results at the Fall 2024 Purdue Undergraduate
            Research Expo.
          </p>
          <br></br>
          <p>
        ...
        <div className="project-images">
          ...
          <img
            src={pedestrian1}
            onClick={() => openModal(pedestrian1)}
            alt="Pedestrian Detection"
          />
        </div>
      </div>
